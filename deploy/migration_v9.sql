-- =====================================================================
-- ADHERE+ migration v9 — Wave 2 (registration risk-history flags)
-- women: height_cm, prior_cs, prior_stillbirth, prior_pph,
--        prior_preeclampsia, prior_obstructed, chronic_htn, diabetes,
--        cardiac_renal
